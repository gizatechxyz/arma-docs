...
ARMA's architecture accepts deposits from any blockchain network, making it convenient to fund your position. Select your deposit token (USDC), specify the amount you wish to deposit and approve.
